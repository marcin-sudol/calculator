  ...
  _createClass(Calculator, [{
    ...
    value: function formatNum(str) {
      if (str === "") return str;else {
        var newStr = parseFloat(str).toPrecision(9);
    ...
    value: function render() {
      ...
      var output = this.state.overflow ? "Overflow" : this.state.previousSign + this.formatNum(this.state.previousNum) + this.state.operator + this.state.currentSign + this.state.currentNum;
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          this.props.buttons.map(function (button) {
            return React.createElement(Button, Object.assign({ key: button.id }, button, { onClick: _this2.handleInput }));
          })
        )
      );
    }
